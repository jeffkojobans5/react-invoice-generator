...
const DownloadSelectCurrency = () => {
    ...
    const saveInvoice = useContext(InvoiceContext)[15]
    ...
    <>
      ...
      <button type="submit" onClick={saveInvoice} className="bg-red-400 text-white px-2 py-2 rounded w-full block mb-10" >  SAVE </button>
